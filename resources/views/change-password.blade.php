...
@section('content')
    ...
    <div class="flex justify-center items-center h-screen px-6" style="margin-bottom:100px;">
        <div class="p-16 max-w-2xl w-full bg-black shadow-md rounded-md"
            style="border-color: #450A0A;box-shadow: 0 0 30px #450A0A;">
            <div class="flex justify-center items-center" style="margin-bottom:50px;">
                    ...
                    <label for="current_password" class="block">
                        <div class="relative">
                            <input name="current_password" type="password"
                                ...
                                id="current_password" required autocomplete="current_password" placeholder="Current Password"><i
