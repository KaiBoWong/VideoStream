                                ...
                                <td class="photo_hoverpointProd" style="position: relative">
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td class="zoom_prod">
                                                    <a href="{{ route('tv.show', $Trendmovie['id']) }}">
                                                        <img src="{{ 'https://image.tmdb.org/t/p/w500/' . $Trendmovie['poster_path'] }}"
                                                            alt="movie poster"
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <div class="mt-2">
                        <a href="{{ route('tv.show', $Trendmovie['id']) }}"
                            class="text-lg mt-2 hover:text-gray:300">{{ $Trendmovie['title'] }}</a>
                        <div class="flex items-center text-gray-400 text-sm mt-1">
                            ...
                            <span class="ml-1">{{ $Trendmovie['vote_average'] }}</span>
