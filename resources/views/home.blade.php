            ...
            <div class="col-md-8">
                <div class="card custom-card">
                    ...
                    <div class="flex justify-center items-center card-header" style="margin-bottom:20px;">
                        ...
                        <span class="text-white font-semibold text-2xl">USER PROFILE PAGE</span>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="row">
                                <a href="{{ route('profile') }}" class="btn">{{ __('Show Profile') }}</a>
                            </div>
                            <div class="row">
                                <a href="{{ route('change.password') }}" class="btn">{{ __('Change Password') }}</a>
                            </div>
                            <div class="row">
                                <a href="{{ route('watch_history') }}" class="btn">{{ __('Watch History') }}</a>
                            </div>
                        </div>
                        @php
