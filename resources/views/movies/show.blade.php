...
@section('content')
    ...
    <div class="movie-info"
        style="background: linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%), url('https://image.tmdb.org/t/p/original/{{ $movie['backdrop_path'] }}') no-repeat center top;">
        <div style="background-color: rgba(0, 0, 0, 0.80);">
                        ...
                        <div class="flex flex-wrap left">
                            @for ($i = 0; $i < count($movie['videos']['results']); $i++)
                                <button class="btn_video"
                                    onclick="changeVideo('{{ $movie['videos']['results'][$i]['key'] }}', this)">
                                    PV{{ $i + 1 }}
                                </button>
                                @if (($i + 1) % 16 === 0)
            ...
            <div class="container mx-auto px-10 py-16 flex flex-col md:flex-row" style="max-width:1366px;">
                ...
                <div class="md:ml-24">
                    <h2 class="text-5xl mt-4 md:mt-0 mb-4 font-semibold">{{ $movie['title'] }}</h2>
                    <div class="flex flex-wrap items-center text-gray-400 text-sm">
                        ...
                        <span class="ml-1">{{ number_format($movie['vote_average'], 2) }}</span>
                        <span class="mx-2">|</span>
