...
@section('content')
    ...
    <div class="movie-info"
        style="background: linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%), url('https://image.tmdb.org/t/p/original/{{ $tvshow['backdrop_path'] }}') no-repeat center top;">
        <div style="background-color: rgba(0, 0, 0, 0.80);">
                ...
                @if (count($tvshow['videos']['results']) > 0)
                    ...
                    <div style="background-color:#ff00004d;" class="py-4 px-4">
                        <div class="flex flex-wrap left">
                            @for ($i = 0; $i < count($tvshow['videos']['results']); $i++)
                                <button class="btn_video"
                                    onclick="changeVideo('{{ $tvshow['videos']['results'][$i]['key'] }}', this)">
                                    PV{{ $i + 1 }}
                                </button>
                                @if (($i + 1) % 16 === 0)
                    ...
                    @else
                    <div class="bg-gray-200 rounded-lg p-4 text-center mt-4 flex justify-center items-center flex-col h-48" style="background-color:rgba(0,0,0,1);">
                        <p class="text-xl font-semibold mb-2">No video available for this TV Show.</p>
            ...
            <div class="container mx-auto px-10 py-16 flex flex-col md:flex-row" style="max-width:1366px;">
                ...
                <div class="md:ml-24">
                    <h2 class="text-5xl mt-4 md:mt-0 mb-4 font-semibold">{{ $tvshow['name'] }}</h2>
                    <div class="flex flex-wrap items-center text-gray-400 text-sm">
                        <span class="ml-1 circle bg-orange-500 text-gray-900">TV</span>
                        ...
                        <span class="ml-1">{{ number_format($tvshow['vote_average'], 2) }}</span>
                        <span class="mx-2">|</span>
                                ...
                                <div class="mt-8">
                                    ...
                                    <div class="mt-2">
                                        <a href="{{ route('tv.show', $movie['id']) }}"
                                            class="text-lg mt-2 hover:text-gray:300">{{ $movie['name'] }}</a>
                                        <div class="flex items-center text-gray-400 text-sm mt-1">
                                            ...
                                            <span class="mx-2">|</span>
                                            <span
                                                style="text-transform: uppercase;">{{ $movie['first_air_date'] }}</span>
